...
namespace MiMenu_Back.Migrations
{
    ...
    [Migration("20250731020956_CreateTableRol")]
            ...
            modelBuilder.Entity("MiMenu_Back.Data.Models.RolModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0a1ac601-880b-4cca-b2b8-7e79ccfe3351"),
                            Name = "client"
                        },
                        new
                        {
                            Id = new Guid("47686657-4e14-412c-8cc1-ea54d2c642b4"),
                            Name = "admin"
                        },
                        new
                        {
                            Id = new Guid("d30e38f1-f0f8-40d9-96ed-81b8d992a764"),
                            Name = "local"
                        });
                });
